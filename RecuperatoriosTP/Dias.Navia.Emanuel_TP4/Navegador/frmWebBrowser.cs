...
namespace Navegador
{
    public partial class frmWebBrowser : Form
    {
        ...
        /// <summary>
        /// accion del boton ir que muestra el codigo html
        /// </summary>
        ...
        private void btnIr_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                descargador.evProgress += new Descargador.EventProgress(this.ProgresoDescarga);
                descargador.evFinalizado += new Descargador.EventCompleted(this.FinDescarga);

                Thread hilo = new Thread(new ThreadStart(descargador.IniciarDescarga));
