...
namespace Entidades_2017
{
    ...
    public sealed class Changuito
    {
        ...
        { 
            /*
            if(this is Dulce)
                return Mostrar(this, ETipo.Dulce);
            else if(this is Snacks)
                return Mostrar(this, ETipo.Snacks);
            else if(this is Leche)
                return Mostrar(this, ETipo.Leche);
            else return Mostrar(this, ETipo.Todos);
             */
